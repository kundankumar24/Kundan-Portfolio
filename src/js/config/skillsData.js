 ...
 * Based on Kundan Kumar Gupta's CV
 */
...
export const skillsData = {
  'Programming Languages': [
    ...
    },
    {
      ...
      yearsExperience: 3,
      icon: '🐍',
      description: 'AI/ML, data analysis, and backend development'
    },
    {
      id: 'javascript',
      name: 'JavaScript',
  ...
  'Core Competencies': [
    {
      ...
      yearsExperience: 3,
      icon: '🧮',
      description: '100+ LeetCode problems solved'
    },
    {
      id: 'ml',
    ...
    },
    {
      ...
      yearsExperience: 1,
      icon: '🧠',
      description: 'AI-powered solutions and models'
    },
    {
      id: 'api-dev',
...
/**
 * Get all skills
 * @returns {Object} All skills grouped by category
 */
 ...
 * @param {number} proficiency - Proficiency percentage
